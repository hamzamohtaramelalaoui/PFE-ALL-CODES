...
type GrafanaConfig struct {
	...
	// LokiDrain3URL points to an optional HTTP service that clusters noisy
	// low-signal Loki messages into reusable templates.
	LokiDrain3URL string

	// LokiDrain3Timeout controls the timeout for requests to the optional
	// Loki Drain3 clustering service.

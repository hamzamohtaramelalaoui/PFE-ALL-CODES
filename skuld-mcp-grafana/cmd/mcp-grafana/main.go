...
type grafanaConfig struct {
	...
	// Loki configuration
	maxLokiLogLimit   int
	lokiDrain3URL     string
	lokiDrain3Timeout time.Duration
}
...
func (gc *grafanaConfig) addFlags() {
	...
	flag.StringVar(&gc.lokiDrain3URL, "loki-drain3-url", tools.DefaultDrain3URL, "HTTP URL for a Drain3 log clustering service used to compress noisy info/debug Loki output")
	flag.DurationVar(&gc.lokiDrain3Timeout, "loki-drain3-timeout", 3*time.Second, "Timeout for requests to the optional Drain3 log clustering service")
}
...
func main() {
	...
	grafanaConfig := mcpgrafana.GrafanaConfig{
		...
		LokiDrain3URL:     gc.lokiDrain3URL,
		LokiDrain3Timeout: gc.lokiDrain3Timeout,
	}
